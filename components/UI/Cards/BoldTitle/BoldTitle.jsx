    ...
    <section className={styles.section}>
      <Container className={styles.grid}>
        <TextReveal className={styles.paragraph}>
          I&apos;ve worked in Web & Mobile development, so I can understand
          programs well and builds effective communication between team members.
        </TextReveal>
        ...
        <TextReveal className={`${styles.paragraph} ${styles.paragraphAlt}`}>
          Currently, I live in Surrey. In my personal life, I love to travel
          with my backpack, watch documentaries about geography, and explore new
          traditional music.
        </TextReveal>
